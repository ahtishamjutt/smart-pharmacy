  ...
  render() {
    return (
      <div>
        ...
        <div className="core_features2 faq_area">
              ...
              <div className="col-xl-12">
                <div className="tab-content" id="nav-tabContent">
                      ...
                      <div className="card">
                        <div className="card-header" id="headingTwo">
                          <h5 className="mb-0">
                            ...
                            >
                              <i className="flaticon-info"></i> Is WordPress
                              hosting worth it?
                            </button>
                          </h5>
                        </div>
                      ...
                      <div className="card">
                        <div className="card-header" id="headingOne">
                          <h5 className="mb-0">
                            ...
                            >
                              <i className="flaticon-info"></i> What are the
                              advantages{" "}
                      ...
                      <div className="card">
                        <div className="card-header" id="headingThree">
                          <h5 className="mb-0">
                            ...
                            >
                              <i className="flaticon-info"></i> Will you
                              transfer my site?
                            </button>
                          </h5>
                        </div>
                      ...
                      <div className="card">
                        <div className="card-header" id="heading_4">
                          <h5 className="mb-0">
                            ...
                            >
                              <i className="flaticon-info"></i> Why should I
                              host with Hostza?
                            </button>
                          </h5>
                        </div>
                      ...
                      <div className="card">
                        <div className="card-header" id="heading_5">
                          <h5 className="mb-0">
                            ...
                            >
                              <i className="flaticon-info"></i> How do I get
                              started <span>with Shared Hosting?</span>
                            </button>
                          </h5>
                        </div>
                        <div
                  ...
                  >
                    <div id="accordion">
                      <div className="card">
                        <div className="card-header" id="headingTwoo">
                          <h5 className="mb-0">
                            <button
                              className="btn btn-link collapsed"
                              data-toggle="collapse"
                      ...
                      <div className="card">
                        <div className="card-header" id="headingThreee">
                          <h5 className="mb-0">
                            <button
                              className="btn btn-link collapsed"
                              data-toggle="collapse"
                      ...
                      <div className="card">
                        <div className="card-header" id="heading_44">
                          <h5 className="mb-0">
                            <button
                              className="btn btn-link collapsed"
                              data-toggle="collapse"
                              data-target="#collapse_44"
                              aria-expanded="false"
                      ...
                      <div className="card">
                        <div className="card-header" id="heading_55">
                          <h5 className="mb-0">
                            <button
                              className="btn btn-link collapsed"
                              data-toggle="collapse"
